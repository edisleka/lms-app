...
//@ts-ignore
// import Four from '@/assets/images/onboarding/4.webp'
...
export const onBoardingSlides: onBoardingSlidesTypes[] = [
  {
    ...
    subTitle:
      'Find the perfect course  to enhance your carrer prospects and skill set',
  },
  {
    color: '#A7F893',
    title: 'Set Your',
  ...
  /*
  {
    ...
    secondTitle: 'Purpose',
    subTitle:
      'Earn certification by successfully completing courses with focused dedication',
  },*/
]

// onboardings variables
export enum Side {
  LEFT,
  RIGHT,
  NONE,
